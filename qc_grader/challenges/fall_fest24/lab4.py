...
def grade_lab4_ex1(list_coefficients: List[List[complex]], list_labels: List[int]) -> None:
    ...
    grade(answer, 'lab4-ex1', _challenge_id, grade_only=_grade_only)
...
def grade_lab4_ex2(
    ...
    grade(answer, 'lab4-ex2', _challenge_id, grade_only=_grade_only)
...
def grade_lab4_ex3(optimize_result: OptimizeResult) -> None:
    ...
    grade(result_values_list, 'lab4-ex3', _challenge_id, grade_only=_grade_only)
...
def grade_lab4_ex4(backend: BackendV2) -> None:
    ...
    grade(gate_error_dict, 'lab4-ex4', _challenge_id, grade_only=_grade_only)
...
def grade_lab4_ex5(amplitude_embedding: Callable) -> None:
    ...
    grade(answer_list, 'lab4-ex5', _challenge_id, grade_only=_grade_only)

@typechecked
def grade_lab4_ex6(results_test: list[float]) -> None:
    grade(results_test, 'lab4-ex6', _challenge_id, grade_only=_grade_only)
...
def grade_lab4_ex7(options_0: EstimatorOptions, options_1: EstimatorOptions) -> None:
    ...
    grade(answer_list, 'lab4-ex7', _challenge_id, grade_only=_grade_only)
