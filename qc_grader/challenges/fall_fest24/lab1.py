...
def grade_lab1_ex1(circuit: QuantumCircuit) -> None:
    grade(circuit, 'lab1-ex1', _challenge_id, grade_only=_grade_only)
...
def grade_lab1_ex2(job: PrimitiveJob) -> None:
    ...
    if status != JobStatus.DONE:
        ...
        }, 'lab1-ex2', _challenge_id, grade_only=_grade_only)


@typechecked
def grade_lab1_ex3(circuit: QuantumCircuit) -> None:
    grade(circuit, 'lab1-ex3', _challenge_id, grade_only=_grade_only)
...
def grade_lab1_ex4(
    ...
    grade(answer, 'lab1-ex4', _challenge_id, grade_only=_grade_only)


@typechecked
def grade_lab1_ex5(circuit: QuantumCircuit) -> None:
    grade(circuit, 'lab1-ex5', _challenge_id, grade_only=_grade_only)
...
def grade_lab1_ex6(cost_func: Callable) -> None:
    ...
    if not isinstance(result, PrimitiveResult):
        ...
        }, 'lab1-ex6', _challenge_id, grade_only=_grade_only)


@typechecked
def grade_lab1_ex7(optimize_result: OptimizeResult) -> None:
    grade(dict(optimize_result), 'lab1-ex7', _challenge_id, grade_only=_grade_only)
