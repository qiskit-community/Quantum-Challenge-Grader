...
def grade_lab1_ex1(qc: QuantumCircuit) -> None:
    grade(qc, 'ex1-1', _challenge_id, byte_string=True)


@typechecked
def grade_lab1_ex2(qc: QuantumCircuit) -> None:
    grade(qc, 'ex1-2', _challenge_id, byte_string=True)


@typechecked
def grade_lab1_ex3(qc: QuantumCircuit) -> None:
    grade(qc, 'ex1-3', _challenge_id, byte_string=True)


@typechecked
def grade_lab1_ex4(qc: QuantumCircuit) -> None:
    grade(qc, 'ex1-4', _challenge_id, byte_string=True)


@typechecked
def grade_lab1_ex5(qc: QuantumCircuit) -> None:
    grade(qc, 'ex1-5', _challenge_id, byte_string=True)


@typechecked
def grade_lab1_ex6(qc: QuantumCircuit) -> None:
    grade(qc, 'ex1-6', _challenge_id, byte_string=True)


@typechecked
def grade_lab1_ex7(numberOfGatesFnc: Callable) -> None:
    inputs = get_problem_set('ex1-7', _challenge_id)
...
def grade_lab1_ex8(qc: QuantumCircuit) -> None:
    grade(qc, 'ex1-8', _challenge_id, byte_string=True)   
