...
# ------------------------------------------------------------------------------------------------------
# SamplerOptions: Edge cases and realistic scenarios
# ------------------------------------------------------------------------------------------------------


def test_sampler_options_only_shots_different_values():
    """Test different shot counts in various realistic scenarios."""
    for shots in [100, 1000, 5000, 10000]:
        full_options = SamplerOptions()
        full_options.default_shots = shots

        subset_options = SamplerOptions()
        subset_options.default_shots = shots
...
def test_sampler_options_dd_disabled_vs_enabled():
    """Test that disabled DD doesn't match enabled DD."""
    full_options = SamplerOptions()
    full_options.dynamical_decoupling.enable = False  # type: ignore
...
def test_sampler_options_realistic_v1_config():
    """Test realistic configuration: basic shots only (v1)."""
    full_options = SamplerOptions()
    full_options.default_shots = 1000
...
def test_sampler_options_realistic_v2_config():
    """Test realistic configuration: shots + DD enabled (v2)."""
    full_options = SamplerOptions()
    full_options.default_shots = 1000
    full_options.dynamical_decoupling.enable = True  # type: ignore
...
def test_sampler_options_realistic_v3_config():
    """Test realistic configuration: shots + DD + twirling (v3)."""
    full_options = SamplerOptions()
    full_options.default_shots = 1000
    full_options.dynamical_decoupling.enable = True  # type: ignore
    full_options.twirling.enable_gates = True  # type: ignore
...
def test_sampler_options_realistic_v4_config():
    """Test realistic configuration: full error mitigation (v4)."""
    full_options = SamplerOptions()
    full_options.default_shots = 1000
    full_options.dynamical_decoupling.enable = True  # type: ignore
    full_options.twirling.enable_gates = True  # type: ignore
