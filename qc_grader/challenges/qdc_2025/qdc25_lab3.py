...
@typechecked
def grade_lab3_ex2(
    mps_energies_t4: numpy.ndarray,
    mps_wp_circ_t4: QuantumCircuit,
    mps_vac_circ_t4: QuantumCircuit,
) -> None:
...
@typechecked
def grade_lab3_ex3(
    t: float, hardware_wp_circ: QuantumCircuit, hardware_vac_circ: QuantumCircuit
) -> None:
...
def grade_lab3_ex4(
    t: float,
    wp_meas_evs: numpy.ndarray,
    vac_meas_evs: numpy.ndarray,
    raw_energies: numpy.ndarray,
) -> None:
...
def grade_lab3_ex6(
    ...
    wp_meas_evs: numpy.ndarray,
    vac_meas_evs: numpy.ndarray,
    mit_sym_energies: numpy.ndarray,
) -> None:
...
def grade_lab3_ex7(
    ...
    wp_meas_evs: numpy.ndarray,
    vac_meas_evs: numpy.ndarray,
    rescaled_mit_sym_energies: numpy.ndarray,
) -> None:
...
def grade_lab3_ex8(
    t: float,
    best_wp_circ: QuantumCircuit,
    best_vac_circ: QuantumCircuit,
    best_energies: numpy.ndarray,
) -> None:
...
@typechecked
def grade_lab3_ex14(
    t: float, best_wp_circ: QuantumCircuit, best_energies: numpy.ndarray
) -> None:

    answer_dict = {"t": t, "best_wp_circ": best_wp_circ, "best_energies": best_energies}
